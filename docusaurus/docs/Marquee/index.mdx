...
description: Marquee — Vevet.js custom marquee component for smooth horizontal or vertical scrolling.
keywords:
  - vevet marquee
  - marquee component
  - scrolling text
...
- **Playback Control via `enabled`**  
  Pause or resume the marquee with `updateProps({ enabled })`.
