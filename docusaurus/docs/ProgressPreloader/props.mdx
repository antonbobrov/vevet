---
sidebar_position: 0
description: ProgressPreloader props — configuration. Vevet.js ProgressPreloader API reference.
keywords:
  - vevet.progresspreloader props
  - vevetjs progress preloader props
  - vevet progress preloader props
  - progress preloader props
---
...
- Emits [`timelineStart`](callbacks#timelinestart), [`timelineUpdate`](callbacks#timelineupdate), and [`timelineEnd`](callbacks#timelineend) during this animation.
