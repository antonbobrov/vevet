---
sidebar_position: 1
description: Cursor accessors — position, state getters. Vevet.js Cursor API reference.
keywords:
  - vevet.cursor accessors
  - vevetjs cursor accessors
  - vevet cursor accessors
  - cursor accessors
---
...
Topmost active hover target registered via `.attachHover()`.

- Available only while hovering an attached element
- Resets to `undefined` when no attached element is hovered
...
cursor.hoveredElement.stickyLerp;
cursor.hoveredElement.stickyFriction;
```
...
**[Read more](props#props.behavior)** / **[Demo](demos#cursor-path-visualization)**
