...
Releases all Snap resources: container and slide resize observers, RAF loop, active Timeline transition, swipe/wheel/interval/keyboard handlers, and slide parallax instances.
