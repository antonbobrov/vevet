...
### `slides` {#props.slides}
- **Type:** (`HTMLElement` | [**SnapSlide**](./slide))[] | `false`; // todo: change link
- **Default:** `false`  
...
- **Type:** `boolean | 'sticky'`
- **Default:** `false`  
- Freemode allows swiping and wheeling with or without magnets snap.
...
- **Type:** `boolean`  
- **Default:** `false`  
- If `false`, the carousel will be animated only when you release the finger, it will not move while you hold your finger on it.  
...
- **Type:** `number`  
- **Default:** `0`  
- The minimum time from the start of a real swipe that identifies the moment the carousel swipe begins.
