...
keywords:
  - vevet.swipe callbacks
  - vevetjs swipe callbacks
  - vevet swipe callbacks
  - swipe callbacks
  - swipe events
---
...
Swipe move event. Payload: [ISwipeCoords](interfaces#iswipecoords) (includes `movement`, `scale`, and `prevMovement` for bounded / snapped / zoomed transforms).
