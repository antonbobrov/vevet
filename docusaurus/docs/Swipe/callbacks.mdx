...
```ts
const destruct = observer.on('toBottom', () => console.log('from top to bottom'));
...
```ts
const destruct = observer.on('toRight', () => console.log('from left to right'));
...
```ts
const destruct = observer.on('pointerdown', ({ event, pointer }) => console.log(event, pointer));
...
```ts
const destruct = observer.on('pointermove', ({ event, pointer }) => console.log(event, pointer));
...
```ts
const destruct = observer.on('pointerup', ({ pointer }) => console.log(pointer));
...
```ts
const destruct = observer.on('preventEdgeSwipe', () => console.log('edge swipe prevented'));
...
```ts
const destruct = observer.on('inertiaStart', () => console.log('inertia start'));
...
```ts
const destruct = observer.on('inertia', () => console.log('inertia in progress'));
...
```ts
const destruct = observer.on('inertiaCancel', () => console.log('inertia cancel'));
