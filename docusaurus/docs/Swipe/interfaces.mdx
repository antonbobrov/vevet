...
keywords:
  - vevet.swipe interfaces
  - vevetjs swipe interfaces
  - vevet swipe interfaces
  - swipe interfaces
  - typescript
---
...
Snapshot on swipe callbacks and accessors. See also [Coordinate spaces](/docs/Swipe#coordinate-spaces).

**Pointer space:** `start`, `prev`, `current`, `diff`, `step`, `accum` — gesture deltas and velocity.  
**Movement space:** `movement`, `prevMovement`, `scale` — after rubber and snap; use for transforms with [`bounds`](props#props.bounds).
