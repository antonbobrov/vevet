...
keywords:
  - vevet.pointers interfaces
  - vevetjs pointers interfaces
  - vevet pointers interfaces
  - pointers interfaces
  - typescript
---
...
Coordinate space depends on [`relative`](props#props.relative): container-relative when `true`, viewport (`clientX` / `clientY`) when `false`.
