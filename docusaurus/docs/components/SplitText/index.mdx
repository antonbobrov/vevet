...
<table>
  ...
  <tr>
    <td>ignore</td>
    <td>Do not split certain elements. Supports string selectors, array of elements, or function.</td>
    <td><code>string | HTMLElement[] | ((element: HTMLElement) => boolean) | null</code></td>
