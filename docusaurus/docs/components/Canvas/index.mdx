...
<table>
  ...
  <tr>
    ...
    <td>Defines which dimension(s) should trigger a resize. [Learn more](/docs/vevet/features#onResize)</td>
    <td>`'width' | 'height' | 'both' | 'onlyWidth' | 'onlyHeight' | 'any' | 'trigger'`</td>
    <td><code>'any'</code></td>
  </tr>
