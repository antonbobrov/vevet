...
export default class Application {
     ...
     * @property {string|Array<number>|Function} [easing=[.25, .1, .25, 1]] - Easing function that is used in animation as a default value. See {@linkcode Vevet.utils.easing}.
     */
    /**
    ...
    /**
     * @description Easing function that is used in animation as a default value. See {@linkcode Vevet.utils.easing} & {@linkcode Vevet.Application#prop}.
     * @readonly
     * @default [.25, .1, .25, 1]
    ...
    _init() {
         ...
         * @private
         */
        this._browser = utils.browserGet();
        /**
         * @type {string}
         * @private
         */
        this._os = utils.osGet();
    ...
    /**
     * @description Get browser name and set it as a class to the HTML element. See {@linkcode Vevet.utils.browserGet}
     * @readonly
     * @type {string}
     */
    get browser() {
    ...
    /**
     * @description Get the operating system name and set it as a class to the HTML element.
     * @readonly
     * @type {string}
     */
    get os() {
