...
/**
 * @classdesc A class for changing pages on ajax requests. It manipulates pages created with the help of {@linkcode Vevet.Page}.
 ...
 * Available targets:
 *  <ul>
 *      <li>click - when a link is clicked.  Each event will receive {@linkcode Vevet.PageAjax.EventLinkHref} as an argument.</li>
 *      <li>popstate - event on popstate. Each event will receive {@linkcode Vevet.PageAjax.EventHref} as an argument.</li>
 *      <li>clickSame - when a link, which href is equal to the current page URL, is clicked. Each event will receive {@linkcode Vevet.PageAjax.EventLinkHref} as an argument.</li> 
 *      <li>prepare - before the request is launched. Each event will receive {@linkcode Vevet.PageAjax.EventLinkHref} as an argument.</li>
 *      <li>loaded - when new content is loaded. Each event will receive {@linkcode Vevet.PageAjax.EventLoaded} as an argument.</li>
 *      <li>updated - when the content is updated. Each event will receive {@linkcode Vevet.PageAjax.EventLoaded} as an argument.</li>
 *      <li>done - when {@linkcode Vevet.PageAjax#loading} becomes false. Each event will receive {@linkcode Vevet.PageAjax.EventLoaded} as an argument.</li>
 *  </ul>
 ...
 */
export default class PageAjax extends Module {
     ...
     * to define the name of the page {@linkcode Vevet.Page}.
     ...
     * 
     * @property {boolean} [on=true] - If false, {@linkcode Vevet.PageAjax#load} will return 'false'.
     ...
     * @property {number} [timeouts.done=100] - Timeout before {@linkcode Vevet.PageAjax#loading} will be false 
     * and events under the target 'done' will be launched.
     * 
     * @property {object} [pageChange] - Moments of changes of states of a page {@linkcode Vevet.Page}.
     ...
     * @property {string} [pageChange.hide=prepare] - {@linkcode Vevet.Page#hide}.
     * @property {string} [pageChange.destroy=loaded] - {@linkcode Vevet.Page#destroy}
