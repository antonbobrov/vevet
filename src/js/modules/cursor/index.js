 ...
 *      <li>render</li>
 *  </ul>
 * <br><br> <b>import {Cursor} from 'vevet';</b>
 * 
 * @class
 * @memberof Vevet
...
export default class Cursor extends Module {
    ...
    _animatePos() {
        ...
        this._pos.x = utils.lerp(this._pos.x, targetX, this._prop.ease);
        this._pos.y = utils.lerp(this._pos.y, targetY, this._prop.ease);
