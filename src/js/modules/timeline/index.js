 ...
 *      <li>reverse</li>
 *  </ul>
 * Each callback will receive the object {@linkcode Vevet.TimelineBase.Data} as an argument.
 * <br><br> <b>import {Timeline} from 'vevet';</b>
 * 
 * @class
 * @memberof Vevet
 * @augments Vevet.TimelineBase
 */
export default class Timeline extends TimelineBase {


    
    /**
     * @memberof Vevet.Timeline
     * @typedef {object} Properties
     * @augments Vevet.TimelineBase.Properties
     * @augments Vevet.Timeline.Settings
     * 
     * @property {boolean} [destroyOnEnd=false] - Destroy the timeline when it ends.
     */
    /**
     * @alias Vevet.Timeline
     * @param {Vevet.Timeline.Properties} data
     */
    constructor(data) {
        super(data);
    }
     ...
     * @readonly
     * @type {Vevet.Timeline.Settings}
     */
    get defaultSettings() {
        return utils.merge(super.defaultSettings, {
            duration: 750,
            autoDuration: false
        });
    }
     ...
     * @memberof Vevet.Timeline
     * @typedef {object} Data
     * @augments Vevet.TimelineBase.Data
     * @property {number} duration - Duration of the animation.
     */
    /**
     * @description Get animation data.
     * @readonly
     * @type {Vevet.Timeline.Data}
     */
    get data() {
        return utils.merge(super.data, {
     ...
     * Common for {@linkcode Vevet.Timeline#play} & {@linkcode Vevet.Timeline#resume}.
     * @private
     */
    _start() {
     ...
     * Common for {@linkcode Vevet.Timeline#stop} & {@linkcode Vevet.Timeline#pause}.
     * @private
     */
    _stop() {
     ...
     * @param {Vevet.Timeline.Settings} data - Settings of the animation.
     * @returns {Vevet.Timeline} Returns 'this'.
     */
    play(data = this._settings) {
        ...
        // get properties
        this._settings = utils.merge(this.defaultSettings, data);
