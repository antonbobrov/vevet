/**
 * @description Calculate timings for each element within one timeline.
 * 
 * @param {number} quantity - Elements quantity.
 * @param {number} shift -  Shift in animation chain between elements. 
 * F.e., if 0.2 then the animation of the second element will start after 80% of animation 
 * of the first element passed.
 * 
 * @returns {Array<Array<number>>} Returns a progress value.
 * 
 * @memberof Vevet.utils
 * @alias Vevet.utils.spreadTimelines
 */
export function spreadTimelines(quantity, shift) {
