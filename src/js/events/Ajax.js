 ...
 * Available targets:
 *  <ul>
 *      <li>load - argument {@linkcode Vevet.Ajax.LoadData}</li>
 *      <li>loaded - argument {@linkcode Vevet.Ajax.CacheItem}</li>
 *  </ul>
 ...
 */
export default class Ajax extends Event {
    ...
    _extra() {
         ...
         * @member {Array<Vevet.Ajax.CacheItem>}
         * @private
         */
        this._cache = [];
     ...
     * @readonly
     * @type {Array<Vevet.Ajax.CacheItem>}
     */
    get cache() {
        return this._cache;
    }
     ...
     * 
     * @param {Vevet.Ajax.LoadData} data - Properties.
     * 
     * @example
     * 
     * ajax.load({
     ...
     * @param {Vevet.Ajax.LoadData} prop - Properties.
     * @private
     */
    _xhr(prop) {
     ...
     * @private
     * 
     * @param {Vevet.Ajax.CacheItem} prop - Object with the request data.
     */
    _cacheSet(prop) {
