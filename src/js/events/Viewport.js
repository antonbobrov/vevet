 ...
 *  </ul>
 * <br>All targets will receive {@linkcode Vevet.Viewport.Callback} as an argument.
 ...
 */
export default class Viewport extends Event {
    ...
    /**
     * @description If mobile device. See {@linkcode Vevet.utils.mobilecheck}
     * @readonly
     * @type {boolean}
     */
    get mobiledevice() {
     ...
     * @property {boolean} mobiledevice If mobile device. See {@linkcode Vevet.utils.mobilecheck}.
