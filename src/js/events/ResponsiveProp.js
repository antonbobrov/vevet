...
import getVevetProperties from './compounds/getVevetProperties';
...
export default class ResponsiveProp {
    ...
    constructor(data, onchange = () => {}, onresponsive = () => {}) {
         ...
         * @protected
         */
        this._propRef = utils.merge({}, data);
        /**
    ...
    _propertiesResponse(resize = false) {
        ...
        if (responsive) {
            ...
            responsive.forEach((obj) => {
                ...
                if (typeof breakpoint == 'number') {
                    if (width <= obj.breakpoint) {
                        newProp = utils.merge(newProp, settings);
            ...
            // otherwise, change the properties
                ...
                this._prop = utils.merge(this._prop, newProp);
            }
