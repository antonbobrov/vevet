 ...
 */
function damp(current, target, factor, delta, approximation) {
    if (approximation === void 0) { approximation = 0; }
    return (0, lerp_1.lerp)(current, target, 1 - Math.exp(-factor * 60 * (delta / 1000)), approximation);
}
