 ...
 */
export const easing = (progress, easingType) => { var _a; if (easingType === void 0) { easingType = (_a = initVevet().props.easing) !== null && _a !== void 0 ? _a : false; } return easingProgress(progress, easingType); };
