 ...
 * @group Components
 */
export class ScrollProgress extends Module {
    /** Retrieves the default static properties. */
    _getStatic() {
        return Object.assign(Object.assign({}, super._getStatic()), { root: null, optimized: true, useSvh: false });
    }
    ...
    _setupScroll() {
        ...
        const listener = addEventListener(container, 'scroll', () => {
            if (this._isVisible) {
                this.update();
            }
        }, { passive: false });
    ...
    get inProgress() {
        ...
        const right = sectionBounds.width > rootBounds.width
            ? 0
            : rootBounds.width - sectionBounds.width;
        const bottom = sectionBounds.height > rootBounds.height
            ? 0
    ...
    get moveProgress() {
        const { rootBounds, sectionBounds } = this;
        const top = sectionBounds.height > rootBounds.height
            ? 0
            : rootBounds.height - sectionBounds.height;
        const right = sectionBounds.width > rootBounds.width
        ...
        const bottom = sectionBounds.height > rootBounds.height
            ...
            : 0;
        const left = sectionBounds.width > rootBounds.width
            ? 0
            : rootBounds.width - sectionBounds.width;
        return this.getProgress(top, right, bottom, left);
    }
