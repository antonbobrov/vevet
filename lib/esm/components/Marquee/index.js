...
export class Marquee extends Module {
    ...
    _getStatic() {
        return Object.assign(Object.assign({}, super._getStatic()), { resizeDebounce: 0, hasWillChange: true, cloneNodes: true });
    }
    /** Get default mutable properties. */
    _getMutable() {
        return Object.assign(Object.assign({}, super._getMutable()), { speed: 1, gap: 0, enabled: true, pauseOnHover: false, centered: false, adjustSpeed: true, pauseOnOut: true });
    }
    ...
    constructor(props) {
        ...
        this._intersection = new IntersectionObserver(this._handleIntersection.bind(this), { root: null });
    ...
    _setup() {
        ...
        this._elements.forEach((element, index) => this._applyNodeStyles(element, index !== 0));
        // initial resize
        this.resize();
        // Resize on page load
     ...
     */
    _applyNodeStyles(element, isAbsolute) {
        const el = element;
    ...
    _render(step = this.props.speed) {
        ...
        for (let index = 0; index < this._elements.length; index += 1) {
            ...
            const x = loop(position + prevStaticX, -elementWidth, this._totalWidth - elementWidth);
