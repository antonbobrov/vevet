 ...
 * removeClickListener();
 */
export declare function addEventListener<Target extends keyof HTMLElementEventMap, Listener extends (event: DocumentEventMap[Target]) => void>(element: Document | Element | Window, target: Target, listener: Listener, options?: boolean | AddEventListenerOptions): () => void;
